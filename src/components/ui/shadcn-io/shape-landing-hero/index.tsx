        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <div className="text-center">
              ...
              <div className="text-xs md:text-sm text-white/40 uppercase tracking-wider">Coût de licence</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">100%</div>
              <div className="text-xs md:text-sm text-white/40 uppercase tracking-wider">Auditable</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">IA</div>
              <div className="text-xs md:text-sm text-white/40 uppercase tracking-wider">Générative Native</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">RGPD</div>
              <div className="text-xs md:text-sm text-white/40 uppercase tracking-wider">Compliant by design</div>
            </div>
          </motion.div>
        </div>
      </div>
